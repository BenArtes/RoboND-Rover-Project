...
def update_rover(Rover, data):
      ...
      'samples collected:', Rover.samples_collected, 'pitch=', Rover.pitch, 'roll=', Rover.roll)
...
def create_output_images(Rover):
      ...
      cv2.putText(map_add,"Time: "+str(np.round(Rover.total_time, 1))+' s'+ ' RFlat:'+str(Rover.flat), (0, 10),
